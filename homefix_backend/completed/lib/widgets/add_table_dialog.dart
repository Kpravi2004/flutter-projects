...
class _AddTableDialogState extends State<AddTableDialog> {
          ...
          children: [
            ...
            Row(
              children: [
                ...
                IconButton(
                  icon: Icon(Icons.remove_circle_outline, color: AppConstants.errorRed),
                ...
                IconButton(
                  icon: Icon(Icons.add_circle_outline, color: AppConstants.successGreen),
  ...
  void _addTable() {
    ...
    print('Table number input: "${tableNumberController.text}"');
    ...
    final int? tableNumber = int.tryParse(tableNumberController.text);
    if (tableNumber == null || tableNumber <= 0) {
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(content: Text('Table number must be a positive number')),
      );
      return;
    }
