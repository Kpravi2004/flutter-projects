...
class TableCard extends StatelessWidget {
  ...
  Color _getSeatColor(int seatIndex) {
    if (seatIndex < table.seats.length) {
      return table.seats[seatIndex].status == 'Occupied'
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: isSelected
            ? BoxDecoration(
          border: Border.all(color: AppConstants.tealPrimary, width: AppConstants.borderThick * 2),
        ...
        child: Stack(
          ...
          children: [
            ...
            ...List.generate(
              topSeats,
                  (index) {
                double totalSeatWidth = (topSeats * seatSize) + ((topSeats - 1) * seatGap);
            ...
            ...List.generate(
              bottomSeats,
                  (index) {
                double totalSeatWidth = (bottomSeats * seatSize) + ((bottomSeats - 1) * seatGap);
                double startX = sideMargin + (tableWidth - totalSeatWidth) / 2;
                double leftOffset = startX + index * (seatSize + seatGap);
                ...
                return Positioned(
                  ...
                  left: leftOffset,
                  child: _buildSeat(index + topSeats, seatSize),
                );
              },
            ),
            ...
            if (table.bills != null && table.bills!.length > 1)
              Positioned(
                ...
                child: Container(
                  padding: const EdgeInsets.symmetric(horizontal: 6, vertical: 2),
                  decoration: BoxDecoration(
                    color: AppConstants.billedPurple,
